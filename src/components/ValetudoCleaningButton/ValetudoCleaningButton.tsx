...
export function ValetudoCleaningButton({
  ...
  const label = [
    fanEntity ? fanCurrent : null,
    waterEntity ? waterCurrent : null,
  ]
    .filter(Boolean)
    .join(' · ');
      ...
      <div className="valetudo-cleaning-button-wrapper">
        ...
        >
          <span className="valetudo-cleaning-button__left">
            <svg className="valetudo-cleaning-button__icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 3C7 3 3 7 3 12s4 9 9 9 9-4 9-9-4-9-9-9zm0 16c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zm1-11h-2v3H8v2h3v3h2v-3h3v-2h-3V8z" fill="currentColor"/>
            </svg>
